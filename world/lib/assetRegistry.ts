...
/** 50 intentionally reviewed, lightweight GLBs. No runtime downloads. */
export const ASSET_REGISTRY: AssetRegistryEntry[] = [
  ...
  entry("bridge", "miscellaneous", "Small Wooden Bridge", ["bridge", "crossing", "river", "stream", "path", "wood", "architecture"], ["wooden bridge", "small bridge", "footbridge", "river crossing"], "environment_feature", [...GROUND, ...WATER], 0.24, "architecture", true, polyPizzaLicense("j4KsIuJYnq")),
  entry("fence", "miscellaneous", "Wooden Fence", ["fence", "boundary", "garden", "yard", "farm", "wood", "architecture"], ["wooden fence", "garden fence", "farm fence", "barrier"], "environment_feature", ["ground", "path", "garden_bed"], 1.8, "architecture", true, polyPizzaLicense("UXmKfG81fG")),
  entry("mailbox", "miscellaneous", "Mailbox", ["mailbox", "postbox", "letter", "mail", "home", "street", "architecture"], ["mail box", "post box", "letterbox", "roadside mailbox"], "standalone_object", ["ground", "path", "floor"], 0.65, "architecture", true, polyPizzaLicense("FCuds5nBko", "Isa Lousberg")),
  entry("well", "miscellaneous", "Stone Well", ["well", "water", "village", "garden", "stone", "architecture"], ["water well", "stone well", "village well", "wishing well"], "environment_feature", ["ground", "garden_bed", "path"], 1, "architecture", true, polyPizzaLicense("QlqncKYxXb")),
  entry("fountain", "miscellaneous", "Garden Fountain", ["fountain", "water", "park", "garden", "plaza", "architecture"], ["water fountain", "garden fountain", "park fountain"], "environment_feature", ["ground", "garden_bed", "path", "water"], 0.4, "architecture", true, polyPizzaLicense("WHc7dwttlk", "Isa Lousberg")),
